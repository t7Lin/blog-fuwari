...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: "https://cf-imgbed-64y.pages.dev/file/1763451886892_background.png", // Background image URL (supports HTTPS)
	...
	favicon: [    // Leave this array empty to use the default favicon
     {
       src: 'https://cf-imgbed-64y.pages.dev/file/1763451886892_background.png',    // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
	...
	name: "L",
	bio: "Everybody has a private world where they can be alone",
	links: [
		{
			name: "Email",
