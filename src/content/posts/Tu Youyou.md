...
## Presentation
**linking:**
- 1.final consonant + initial vowel
  - pai**d o**ff
- 2. /r/ linking
  - afte**r i**ts discovery
- 3. final vowel + initial vowel, insert /j/ or /w/
  - /j/ ; final vowel `/iː/`, `/ɪ/`, `/eɪ/`, `/aɪ/`, /ɔɪ/
```
- `I am` → `[aɪ jæm]`
...
- `The boy is` → `[ðə bɔɪ jɪz]`
```
 
  - /w/; final vowel `/uː/`, `/ʊ/`, `/əʊ/`, /aʊ/
```
- `Go out` → `[ɡəʊ waʊt]`
...
trial and error
part of
rise it to a higher level level
## Production
Retell the story by yourself, use linking